        ...
        <div class="main-content"><!-- CONTENT-->
            <div class="content">
                <div class="section page-title property-view bg-overlay">
                    <div class="container">
                        <div class="page-title-wrapper"><h2 class="captions texto-mi-color">Listado Completo de Propiedades</h2>
                            <ol class="breadcrumb">
                                <li><h5 style="color: white">Ofrecemos soluciones integrales a sus necesidades inmobiliarias</h5></li>
                        ...
                        <div class="property-wrapper padding-top">
                            <div class="row">
                                <div class="col-md-8 property-content">
                                    <div class="row" id="mi-listado">
                                        <div id="loading"><img id="loading-image" src="assets/images/loader.gif" alt="load list"/></div>
                                            @if($propiedades)
                                                @foreach($propiedades as $propiedad)
                                            <div class="property-item col-xs-6">
                                                <div class="sunhouse-item"><a href={{'/propiedades/'.$propiedad->codigo.'/#galeria'}} class="wrapper-image"><img src={{'/uploads/'.$propiedad->codigo.'/Thumbnail/'.$propiedad->codigo.'-0.JPG'}} alt="" class="img-responsive layout-1"/><img src={{'/uploads/'.$propiedad->codigo.'/Thumbnail/'.$propiedad->codigo.'-1.JPG'}} alt="" class="img-responsive layout-2"/></a>
                                                ...
                                                <div class="wrapper-content">
                                                    ...
                                                    <div class="more-info-house">
                                                        <div class="place-house"><i class="fa fa-map-marker"></i><a >{{$propiedad->calle .' '.$propiedad->numero}}</a>
                                                        </div>
                                                        <div class="price">
                                ...
                                <div class="col-md-4 sidebar">
                                 <!--   <div class="search-widget widget">
                                        <div class="title-widget">Filtros</div>
                                            ...
                                            <div class="search-form row">
                                                <div class="col-md-12 col-xs-6">
                                                    <div class="search-form-group">
                                                        <label class="title-search-form">codigo</label>
                                                        <input id="busqueda-1-codigo" type="text" placeholder="Código de propiedad (Opcional)" class="input-form text-center"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 col-xs-6">
...
@stop
@section('script')
    {{HTML::script("assets/js/listado.js")}}
